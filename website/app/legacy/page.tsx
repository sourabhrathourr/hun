...
export const metadata: Metadata = {
  title: "hun CLI — legacy project switching workflow",
  description:
    "The original Hun command-line workflow for switching projects, services, ports, and logs.",
  alternates: {
    canonical: "/legacy",
  },
  openGraph: {
