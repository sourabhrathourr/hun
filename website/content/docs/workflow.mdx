...
You open your terminal. You are working on the main product, `acme-core`.
...
You are instantly in the TUI. You see the database come up (Green), then the API (Green), then the Frontend (Green).
